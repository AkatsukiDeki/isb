...
class Symmetric:
    ...
    def encryption(
        ...
        origin_text = Work.read_bytes(text_file_path)
        ...
        Work.write_bytes_text(encrypted_text_file_path, encrypted_text)
    ...
    def decryption(
        ...
        Returns:
            str: decrypted text
        """
        nonce = Work.read_bytes_from_text(path_to_nonce)
        encrypted_text = Work.read_bytes_from_text(path_to_encrypted_text)
        symmetric_key = Serialization.symmetric_key_deserialization(path_to_symmetric)
        cipher = Cipher(
        ...
        Work.write_file(path_to_decrypted_text, dec_unpad_text)
